...
> 本文件覆盖两条线:**1.21.x**(`OptiFabric-1.1.0+mc1.21.x.jar`)与 **26.1.2**(`OptiFabric-Reforged-1.2.1+mc26.1.2.jar`)。26.1 起 Minecraft 未混淆,走另一套构建与运行期路径,而且**要求 Java 25**(1.21.x 是 Java 21)—— 两条线的 jar 不能互相替代。
...
| **26.1.2** | `OptiFabric-Reforged-1.2.1+mc26.1.2.jar` | `preview_OptiFine_26.1.2_HD_U_K1_pre2.jar` (**Java 25**) |
...
| 1.21.10 | `OptiFabric-1.1.0+mc1.21.10.jar` | `preview_OptiFine_1.21.10_HD_U_J7_pre11.jar` |
| 1.21.11 | `OptiFabric-1.1.0+mc1.21.11.jar` | `OptiFine_1.21.11_HD_U_J9.jar` |
| **26.1.2** | `OptiFabric-Reforged-1.2.1+mc26.1.2.jar` | `preview_OptiFine_26.1.2_HD_U_K1_pre2.jar`(**要 Java 25**) |
