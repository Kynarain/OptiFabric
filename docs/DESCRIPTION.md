...
> 本文件覆盖两条线:**1.21.x**(`OptiFabric-1.1.0+mc1.21.x.jar`)与 **26.1.2**(`OptiFabric-Reforged-2.0.0+mc26.1.2.jar`)。26.1 起 Minecraft 未混淆,走另一套构建与运行期路径,而且**要求 Java 25**(1.21.x 是 Java 21)—— 两条线的 jar 不能互相替代。
